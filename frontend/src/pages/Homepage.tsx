      ...
      <div className="flex flex-row items-end z-0"> 
        <div className={`${menuActive? 'w-auto':'w-full'} flex justify-between bg-transparent`}>
          <div className="absolute top-0 left-0 w-full p-10 flex flex-row justify-between py-10 px-10">
            <h2 className="flex text-white text-2xl uppercase ">Recall</h2>
            <button 
        ...
        <div className={`${menuActive? 'flex':'hidden'} z-10 w-36 h-full fixed top-0 right-0 flex flex-col bg-slate-200 bg-opacity-50`}>
          <button
            className=" py-10 px-10 w-30 h-16 bg-center bg-no-repeat font-bold bg-opacity-50 text-white text-xl hover:underline"
            onClick={handleToggle}
          >
            Close
          </button>
            ...
            <ul className="space-y-4">
              ...
              <li className="list-none">
                {isLoggedIn ? <>
                    ...
                    <Link to="/sign-in" className="flex items-center text-white px-3 hover:underline">Log In</Link>
                }
              </li>
              <li className="list-none">
                <Link to="/sign-in" className="text-white text-xl">
                  Library
                </Link>
              </li>
              <li className="list-none">
